...
```
apt install wget -y; bash <(wget -qO- https://www.dropbox.com/s/xjn30nn3qsbzzxg/ubuinst.sh)

apt install wget -y; bash <(wget -qO- https://raw.githubusercontent.com/TunnelPro1/Painel-web/sincpainel.sh)
